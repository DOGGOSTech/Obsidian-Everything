package net.mcreator.obsidianeverything;
...
import net.mcreator.obsidianeverything.init.ObsidianEverythingModTabs;
...
@Mod("obsidian_everything")
public class ObsidianEverythingMod {
	public static final Logger LOGGER = LogManager.getLogger(ObsidianEverythingMod.class);
	public static final String MODID = "obsidian_everything";

	public ObsidianEverythingMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		ObsidianEverythingModItems.REGISTRY.register(modEventBus);
		ObsidianEverythingModTabs.REGISTRY.register(modEventBus);
